  ...
  return (
    <div className="w-full border-2 border-transparent h-max flex justify-center items-start bg-gray-200 ">
      <div className="w-full max-w-mid_screen lg:mx-2 flex justify-center items-center">
        {/* MANAGEMENT BLOCK */}
        <div className="lg:w-3/12 lg:mx-1 md:w-4/12 flex justify-center items-start rounded-sm">
          <div className="fixed top-19 lg:w-sb xl:w-80 md:w-80 h-fit bg-white rounded-sm flex flex-col justify-start items-center font-semibold text-lg">
        ...
        <div className="w-content lg:ml-4 xl:ml-2 h-full bg-gray-200 flex justify-center items-start rounded-sm ">
